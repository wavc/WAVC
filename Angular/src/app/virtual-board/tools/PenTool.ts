...
export class PenTool extends Tool {
    ...
    constructor(private signaRConnection:signalR.HubConnection, strokeColor: Color, strokeWidthRef: { Value: number }) {
        super();
    ...
    onMouseDown = (event) => {
        ...
        this.signaRConnection.send("SendOnMouseDownEvent", this.myId, ["pen", event.point, this.strokeColor]);
        
    }
    onMouseDrag = (event) => {
        this.tryOnMouseDrag(event.point, this.strokeColor, this.strokeWidthRef.Value);
        this.signaRConnection.send("SendOnMouseDragEvent", this.myId, ["pen", event.point, this.strokeColor, this.strokeWidthRef.Value]);
    }
